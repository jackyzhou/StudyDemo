...
namespace StudyDemo.Manager
{
    ...
    {
        public static ProfileDTO ProfileToProfileDTO(ProfileAggregate profile, List<AddressType> addressTypes, List<PhoneType> phoneTypes)
        {
        ...
        public static AddressDTO AddressToAddressDTO(AddressAggregate address)
        {
        ...
        public static PhoneDTO PhoneToPhoneDTO(PhoneAggregate phone)
        {
