...
using StudyDemo.Framework.Core.Logging;
using StudyDemo.Framework.Core.Validator;
using StudyDemo.Manager.Resources;
using StudyDemo.Repository;
using System;
using System.Linq;
using System.Collections.Generic;

namespace StudyDemo.Manager
{
    public class ContactManager : IContactManager
    {
        ...
        public List<ProfileDTO> FindProfiles(int pageIndex, int pageCount)
        {
                ...
                profiles.Any())
            {
                ...
                {
                    lstProfileDTO.Add( Mapping.ProfileToProfileDTO(profile, addressTypes, phoneTypes));
                }
        ...
        public void DeleteProfile(int profileId)
        {
            ...
            if (profile != null) //if profile exist
            {
                ...
                List<ProfileAddressAggregate> lstProfileAddress = profile.ProfileAddresses.ToList();
                foreach (ProfileAddressAggregate objProfileAddress in lstProfileAddress)
                {
                    this.DeleteProfileAddress(objProfileAddress);
                }

                //Delete all phones associate with this profile 
                List<ProfilePhoneAggregate> lstProfilePhone = profile.ProfilePhones.ToList();
                foreach (ProfilePhoneAggregate objProfilePhone in lstProfilePhone)
                {
        ...
        public ContactForm InitializePageData()
        {
            ...
            objContactForm.lstAddressTypeDTO = Mapping.AddressTypeToAddressTypeDTO(addressTypes);
            objContactForm.lstPhoneTypeDTO = Mapping.PhoneTypeToPhoneTypeDTO(phoneTypes);
        ...
        public void UpdateProfileInformation(int id, ProfileDTO profileDTO)
        {
            ...
            var updatedProfile = new ProfileAggregate();
            ...
            List<ProfileAddressAggregate> lstCurrentAddress = _profileAddressRepository.GetFiltered(x => x.ProfileId.Equals(id)).ToList();

            UpdateAddress (lstUpdatedAddressDTO, lstCurrentAddress, updatedProfile);

            //Update Phone
            List<PhoneDTO> lstUpdatedPhoneDTO = profileDTO.PhoneDTO;
            List<ProfilePhoneAggregate> lstCurrentPhone = _profilePhoneRepository.GetFiltered(x => x.ProfileId.Equals(id)).ToList();
        ...
        void SaveAddress(AddressDTO addressDTO, ProfileAggregate profile)
        {
        ...
        AddressAggregate SaveAddress(AddressAggregate address)
        {
        ...
        void SaveProfileAddress(ProfileAddressAggregate profileAddress)
        {
            var entityValidator = EntityValidatorFactory.CreateValidator();
        ...
        void UpdateAddress(List<AddressDTO> lstUpdatedAddressDTO, List<ProfileAddressAggregate> lstCurrentAddress, ProfileAggregate profile)
        {
            //if addressDTO data is not valid
            ...
            {
                foreach (ProfileAddressAggregate profileAddress in lstCurrentAddress)
                {
            ...
            foreach (ProfileAddressAggregate profileAddress in lstCurrentAddress)
            {
                ...
                {
                    AddressAggregate updatedAddress = new AddressAggregate();
        ...
        /// </summary>
        /// <param name="profile"></param>
        void UpdateAddress(AddressAggregate currentAddress, AddressAggregate updatedAddress)
        {
        ...
        /// </summary>
        /// <param name="profileId"></param>
        public void DeleteProfileAddress(ProfileAddressAggregate profileAddress)
        {
        ...
        /// <param name="profile"></param>
        void SavePhone(PhoneDTO phoneDTO, ProfileAggregate profile)
        {
        ...
        PhoneAggregate SavePhone(PhoneAggregate phone)
        {
            var entityValidator = EntityValidatorFactory.CreateValidator();
        ...
        void SaveProfilePhone(ProfilePhoneAggregate profilePhone)
        {
            var entityValidator = EntityValidatorFactory.CreateValidator();
        ...
        void UpdatePhone(List<PhoneDTO> lstUpdatedPhoneDTO, List<ProfilePhoneAggregate> lstCurrentPhone, ProfileAggregate profile)
        {
            //if addressDTO data is not valid
            ...
            {
                foreach (ProfilePhoneAggregate profilePhone in lstCurrentPhone)
                {
            ...
            foreach (ProfilePhoneAggregate profilePhone in lstCurrentPhone)
            {
                ...
                if (objPhoneDTO != null)
                {
                    PhoneAggregate updatedPhone = new PhoneAggregate();
        ...
        void UpdatePhone(PhoneAggregate currentPhone, PhoneAggregate updatedPhone)
        {
        ...
        /// </summary>
        /// <param name="profilePhone"></param>
        public void DeleteProfilePhone(ProfilePhoneAggregate profilePhone)
        {
        ...
        /// </summary>
        /// <param name="profile"></param>
        ProfileAggregate SaveProfile(ProfileAggregate profile)
        {
            var entityValidator = EntityValidatorFactory.CreateValidator();
        ...
        /// </summary>
        /// <param name="profile"></param>
        ProfileAggregate UpdateProfile(ProfileAggregate currentProfile, ProfileAggregate updatedProfile)
        {
