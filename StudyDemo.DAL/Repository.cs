...
namespace StudyDemo.DAL
{
        ...
        where T : class
    {
        ...
        public virtual void Add(T item)
        {
            ...
            else
            {
                LoggerFactory.CreateLog()
                          .LogInfo(Messages.info_CannotAddNullEntity, typeof(T).ToString());
        ...
        public virtual void Remove(T item)
        {
            ...
            {
                LoggerFactory.CreateLog()
                          .LogInfo(Messages.info_CannotRemoveNullEntity, typeof(T).ToString());
            }
        }
