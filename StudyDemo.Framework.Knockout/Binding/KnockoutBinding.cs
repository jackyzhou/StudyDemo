...
namespace StudyDemo.Framework.Knockout
{
    public class KnockoutBinding<TModel> : KnockoutSubContext<TModel>, IHtmlString
    {
        ...
        public KnockoutBinding<TModel> Attr(string name, string value)
        {
            ComplexItem("attr").Add(new KnockoutBindingStringItem(name, value, false));
            return this;
        }
        ...
        public virtual string ToHtmlString()
        {
            ...
            builder.Append(BindingAttributeContent());
            builder.Append(@"""");
