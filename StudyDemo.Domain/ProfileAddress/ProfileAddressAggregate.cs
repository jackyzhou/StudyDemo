...
{
    public partial class ProfileAddressAggregate : Entity, IValidatableObject
    {
        #region Property
        ...
        public void AssociateProfileForThisProfileAddress(ProfileAggregate profile)
        {
            if (profile == null)
            {
        ...
        public void AssociateAddressForThisProfileAddress(AddressAggregate address)
        {
            if (address == null)
            {
