...
{
    public partial class ProfilePhoneAggregate : Entity, IValidatableObject
    {
        #region Property
        ...
        public virtual PhoneAggregate Phone { get; set; }
        public virtual PhoneType PhoneType { get; set; }
        public virtual ProfileAggregate Profile { get; set; }
        ...
        public void AssociateProfileForThisProfilePhone(ProfileAggregate profile)
        {
            if (profile == null)
            {
        ...
        public void AssociatePhoneForThisProfilePhone(PhoneAggregate phone)
        {
            if (phone == null)
            {
